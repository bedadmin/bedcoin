...
static UniValue generatetodescriptor(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
        ...
        "\nMine blocks immediately to a specified descriptor (before the RPC call returns)\n",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated bedcoin to."},
        ...
        return NullUniValue;
            ...
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated bedcoin to."},
                    {"maxtries", RPCArg::Type::NUM, /* default */ "1000000", "How many iterations to try."},
                },
                RPCResult{
                    RPCResult::Type::ARR, "", "hashes of blocks generated",
            ...
            + "If you are running the bedcoin core wallet, you can get a new address to send the newly generated bedcoin to with:\n"
    ...
    if (scriptReward.empty()) {
        ...
        if (scriptReward.empty())
            ...
            RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/bedcoin/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/bedcoin/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/bedcoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/bedcoin/bips/blob/master/bip-0145.mediawiki\n",
                {
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    // We allow 2 arguments for compliance with BIP22. Argument 2 is ignored.
            RPCHelpMan{"submitblock",
                ...
                "See https://en.bedcoin.it/wiki/BIP_0022 for full specification.\n",
                {
