    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getnewaddress",
                "\nReturns a new Bedcoin address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new bedcoin address"
                },
                RPCExamples{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getrawchangeaddress",
                "\nReturns a new Bedcoin address, for receiving change.\n"
...
static UniValue setlabel(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"setlabel",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bedcoin address to be associated with a label."},
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Bedcoin address");
    }
...
static UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bedcoin address to send to."},
            ...
            "                             The recipient will receive less bedcoins than you enter in the amount field."},
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            {RPCResult::Type::ARR, "", "",
                            {
                                {RPCResult::Type::STR, "address", "The bedcoin address"},
...
static UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bedcoin address to use for the private key."},
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getreceivedbyaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bedcoin address for transactions."},
...
static UniValue sendmany(const JSONRPCRequest& request)
{
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    ...
                    {"amounts", RPCArg::Type::OBJ, RPCArg::Optional::NO, "The addresses and amounts",
                        {
                            {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "The bedcoin address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value"},
                        },
                    },
            ...
            "                           Those recipients will receive less bedcoins than you enter in their corresponding amount field.\n"
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Bedcoin address: ") + name_);
        }
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"addmultisigaddress",
                ...
                "Each key is a Bedcoin address or hex-encoded public key.\n"
                "This functionality is only intended for use with non-watchonly addresses.\n"
                "See `importaddress` for watchonly p2sh address support.\n"
                "If 'label' is specified, assign address to that label.\n",
                {
                    {"nrequired", RPCArg::Type::NUM, RPCArg::Optional::NO, "The number of required signatures out of the n keys or addresses."},
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "The bedcoin addresses or hex-encoded public keys",
                        {
                            {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "bedcoin address or hex-encoded public key"},
                        },
                        },
            ...
            "              with the specified label, or \"*\" to disable filtering and return all transactions."},
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        ...
                        {
                            {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction."},
                            {RPCResult::Type::STR, "address", "The bedcoin address of the transaction."},
                ...
                RPCResult{
                    ...
                    TransactionDescriptionString()),
                    {
                        {RPCResult::Type::ARR, "details", "",
                        {
                            ...
                            {
                                {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction."},
                                {RPCResult::Type::STR, "address", "The bedcoin address involved in the transaction."},
                                {RPCResult::Type::STR, "category", "The transaction category.\n"
                                    "\"send\"                  Transactions sent.\n"
                                    "\"receive\"               Non-coinbase transactions received.\n"
                                    "\"generate\"              Coinbase transactions received with more than 100 confirmations.\n"
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"walletpassphrase",
                ...
                "This is needed prior to performing transactions related to private keys such as sending bedcoins\n"
            "\nNote:\n"
...
static UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending bedcoin\n"
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"lockunspent",
                ...
                "A locked transaction output will not be chosen by automatic coin selection, when spending bedcoins.\n"
...
static UniValue loadwallet(const JSONRPCRequest& request)
{
            RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting bedcoind will be"
...
static UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "The bedcoin addresses to filter",
                        {
                            {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "bedcoin address"},
                        },
                    },
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Bedcoin address: ") + input.get_str());
            }
    ...
    if (!options.isNull()) {
      if (options.type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid bedcoin address");
            }
    ...
    RPCHelpMan{"fundrawtransaction",
                ...
                "Only pay-to-pubkey, multisig, and P2SH versions thereof are currently supported for watch-only\n",
                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "for backward compatibility: passing in a true instead of an object will result in {\"includeWatching\":true}",
                        {
                            {"changeAddress", RPCArg::Type::STR, /* default */ "pool address", "The bedcoin address to receive the change"},
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getaddressinfo",
                "\nReturn information about the given bedcoin address.\n"
                "Some of the information will only be present if the address is in the active wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bedcoin address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The bedcoin address validated."},
            ...
            "                                                         getaddressinfo output fields for the embedded address, excluding metadata (timestamp, hdkeypath,\n"
                            ...
                            "as an array to keep the API stable if multiple labels are enabled in the future.",
                        {
                            ...
                            {RPCResult::Type::OBJ, "", "label data, DEPRECATED, will be removed in 0.21. To re-enable, launch bedcoind with `-deprecatedrpc=labelspurpose`",
                            {
                ...
                "Implements the Creator and Updater roles.\n",
                {
                    ...
                    {"outputs", RPCArg::Type::ARR, RPCArg::Optional::NO, "The outputs (key-value pairs), where none of the keys are duplicated.\n"
                            ...
                            "                             accepted as second parameter.",
                        {
                            {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                {
                                    {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the bedcoin address, the value (float or string) is the amount in " + CURRENCY_UNIT + ""},
                                },
                                },
                            {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "",
                        {
                            {"changeAddress", RPCArg::Type::STR_HEX, /* default */ "pool address", "The bedcoin address to receive the change"},
                            {"changePosition", RPCArg::Type::NUM, /* default */ "random", "The index of the change output"},
                            {"change_type", RPCArg::Type::STR, /* default */ "set by -changetype", "The output type to use. Only valid if changeAddress is not specified. Options are \"legacy\", \"p2sh-segwit\", and \"bech32\"."},
                            {"includeWatching", RPCArg::Type::BOOL, /* default */ "true for watch-only wallets, otherwise false", "Also select inputs which are watch only"},
                            {"lockUnspents", RPCArg::Type::BOOL, /* default */ "false", "Lock selected unspent outputs"},
...
static UniValue getaddresstickets(const JSONRPCRequest& request)
{
    std::shared_ptr<CWallet> const wallet = GetWalletForJSONRPCRequest(request);
    CWallet* const pwallet = wallet.get();
        ...
        RPCHelpMan{"getaddresstickets",
            ...
            RPCResult{
                RPCResult::Type::ARR, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "lockheight", "lockheight,(int) The height above which the tickets could be withdrawed"},
                    {RPCResult::Type::BOOL, "state", /* optional */ false, "useable,	    whether the tickets can be withdrawed"},
                }
            },
            RPCExamples{
                HelpExampleCli("getaddresstickets", "\"1PGFqEzfmQch1gKD3ra4k18PNj3tTUUSqg\"")
        + HelpExampleCli("getaddresstickets", "\"1PGFqEzfmQch1gKD3ra4k18PNj3tTUUSqg\" 6 9999999 true")
            },
        }.Check(request);
	...
	for (auto iter = tickets.begin();iter!=tickets.end();iter++){
        ...
        entry.pushKV("isSpent", coinsview.AccessCoin(*out).IsSpent());
		results.push_back(entry);
	}
...
static UniValue listtickets(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        ...
        RPCExamples{
            ...
            + HelpExampleCli("listtickets", "10")
            + HelpExampleCli("listtickets", "10 true")
        },
        }.Check(request);
...
UniValue buyticket(const JSONRPCRequest& request)
{
        ...
        return NullUniValue;
            ...
            RPCHelpMan{
                ...
                "\nFreeze some funds to get miner ticket\n",
                {
                    ...
                    {"changeAddr", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to recvie BED change(only keyid)."},
                },
                RPCResult{
    ...
    if (changedest.type() != typeid(PKHash)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Only support PUBKEYHASH");
    }

    auto keyID = CKeyID(boost::get<PKHash>(dest));
    auto changekeyID = CKeyID(boost::get<PKHash>(changedest));
    ...
    //set change dest
    CCoinControl coin_control;
    coin_control.destChange = CTxDestination(PKHash(changekeyID));
    ...
    pwallet->ImportScriptPubKeys("tickets", scripts, false /* have_solving_data */, true /* apply_label */, 1 /* timestamp */);
    return tx->GetHash().GetHex();
}
...
CTransactionRef CreateTicketSpendTx(CWallet* const pwallet, const CScript& redeemScript, const uint256& txid, const int n, const CTxOut& out, CTxDestination& dest, CKey& key)
{
...

	{
	  ...
	  nBytes += CPubKey::SIGNATURE_SIZE + CPubKey::SIZE;
...
UniValue freeticket(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{
                ...
                RPCExamples{
                    HelpExampleCli("freeticket", "\"8199ceda82a056700475d645e2a0cd588b6853e87e1b4b8a459814078799dd87\" \"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")},
            }
    .Check(request);
    ...
    auto tx = CreateTicketSpendTx(pwallet, redeemScript, prevTx->GetHash(), n, prevTx->vout[n], dest, vchSecret);
    if (!tx) {
...
CTransactionRef CreateTicketAllSpendTx(CWallet* const pwallet, std::map<uint256,std::pair<int,CScript>> txScriptInputs, std::vector<CTxOut> outs, CTxDestination& dest, CKey& key)
{
	...
	for(auto iter=txScriptInputs.begin(); iter!=txScriptInputs.end(); iter++){
		...
		pubKeySizeSum += CPubKey::SIGNATURE_SIZE + CPubKey::SIZE;
		index++;
	}
...
UniValue freeaddresstickets(const JSONRPCRequest& request){
	...
	if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
		return NullUniValue;
            ...
            RPCResult{
                RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::ARR, "tickethash", "", {
                        {RPCResult::Type::STR, "", "(string)the tickethash"},
                    }},
                    {RPCResult::Type::STR, "txid", "(string)the tickethash"},
                }
                
            },
			RPCExamples{
				HelpExampleCli("freeaddresstickets", "\"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\" \"1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")},
			}
	.Check(request);
	...
	if (receiver.type() != typeid(PKHash)) {
		throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Only support PUBKEYHASH");
	}
	...
	for(auto iter = tickets.begin(); iter!=tickets.end(); iter++){
		...
		if (state == CTicket::CTicketState::OVERDUE){
			...
			// construct the freeaddresstickets tx inputs.
			auto prevTx = MakeTransactionRef();
			uint256 hashBlock;
			if (!GetTransaction(txid, prevTx, Params().GetConsensus(), hashBlock)) {
	...
	auto tx = CreateTicketAllSpendTx(pwallet, txScriptInputs, outs, receiver, vchSecret);
...
UniValue getslotinfo(const JSONRPCRequest& request)
{
            RPCHelpMan{ "getslotinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "","",
                    {
                        {RPCResult::Type::NUM, "index", " xx,                  (numeric) the index of fire stone slot"},
                        {RPCResult::Type::NUM, "price", " xxxxxx,              (numeric) the current price of fire stone slot"},
                        {RPCResult::Type::NUM, "count", " xx,                  (numeric) the count of tickets in this slot"},
                        {RPCResult::Type::NUM, "locktime", " xxxxx,            (numeric) the end of this slot"},
                    }
                },
                RPCExamples{
...
{ //  category              name                                actor (function)                argNames
    ...
    { "ticket",             "freeticket",                       &freeticket,                    {"txid", "vout", "redeem", "address"} },
